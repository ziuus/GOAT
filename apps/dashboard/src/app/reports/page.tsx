          ...
          {filteredReports.map(report => (
            ...
            >
              ...
              <div className="flex justify-between items-center mt-2">
                <span className="text-xs text-slate-500">{report.agent}</span>
        ...
        {selectedReport ? (
          <div className="max-w-4xl mx-auto space-y-8">
            <PageHeader 
              ...
              subtitle={`Generated by ${selectedReport.agent} at ${new Date(selectedReport.date).toLocaleString()}`}
            />
            <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-6">
              <pre className="text-sm text-slate-300 font-mono whitespace-pre-wrap">{selectedReport.content}</pre>
            </div>
          </div>
        ) : (
          <EmptyState 
