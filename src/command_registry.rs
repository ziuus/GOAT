...
fn all_commands() -> Vec<CommandMetadata> {
    vec![
        ...
        CommandMetadata {
            ...
            aliases: &[],
            category: CommandCategory::Memory,
            description: "Manage unified brain index: status, index, reindex, search, recall, related, sources, privacy",
            usage: "/brain [status|index|reindex|search <q>|recall <q>|related <id>|sources|privacy]",
            examples: &[
                "/brain status",
                "/brain index",
                "/brain search rust",
