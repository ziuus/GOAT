...
export default function LearnerPage() {
  ...
  return (
    <PageShell>
      <PageHeader 
        title="Learner OS"
        subtitle="Structured Journey, Roadmap Tracks, and Realistic AI Scheduling."
        actions={
          <button 
      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-12 md:col-span-9">
          {selectedGoal ? (
            ...
            <EmptyState title="Select a learning track" description="Choose a track from the sidebar or create a new one." icon={<Compass className="w-16 h-16 opacity-20 text-blue-400" />} />
          )}
        </div>
