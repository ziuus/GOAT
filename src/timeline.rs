...
pub enum TimelineEventKind {
    ...
    PromptForgeRefined,
    PromptForgeBypassed,
    DesignerReviewCreated,
    DesignerScorecardCreated,
    DesignerAccessibilityChecked,
    DesignerImprovementPlanCreated,
    DesignerHandoffCreated,
    DesignerReportGenerated,
    ResearcherTopicCreated,
    ResearcherPlanCreated,
    ResearcherSourceAdded,
    ResearcherEvidenceNoteCreated,
    ResearcherCompetitorScanCreated,
    ResearcherComparisonCreated,
    ResearcherBriefCreated,
    ResearcherReportGenerated,
    ResearcherHandoffCreated,
    OperatorSystemCreated,
    OperatorHealthCheckCreated,
    OperatorLogReviewCreated,
    OperatorIncidentCreated,
    OperatorDeploymentPlanCreated,
    OperatorCiReviewCreated,
    OperatorRollbackPlanCreated,
    OperatorRunbookCreated,
    OperatorReportGenerated,
    LearnerGoalCreated,
    LearnerLevelAssessed,
    LearnerRoadmapCreated,
    LearnerWeeklyPlanCreated,
    LearnerDailyPlanCreated,
    LearnerPracticeCreated,
    LearnerRevisionCreated,
    LearnerProgressUpdated,
    LearnerReportGenerated,
    LearnerBuilderHandoffCreated,
    Other(String),
    BrainIndexCompleted,
